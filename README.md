...
<details>
  <summary>Добавление пользователя Windows 10</summary>
...
<details>
  <summary>Добавление пользователя Windows 7</summary>
...
<details>
  <summary>1. Через редактор групповых политик gpedit.msc (затратно по времени, но есть возможность гибких настроек)</summary>

</details>

<details>
  <summary>2. Внесение изменений в реестр напрямую (быстро, но доступна лишь часть настроек)</summary>
