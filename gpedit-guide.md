...
**Если приведенный выше способ не сработал, используйте внесение изменений в реестр [напрямую.](https://github.com/auto-no-mous/Clean-school-computer-win#шаг-4-проверка-работоспособности-запрещающих-настроек)**
